        ...
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="prefix" value="{{ old('prefix') }}" maxlength="10"
                       class="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono uppercase @error('prefix') border-red-400 dark:border-red-500 @enderror"
                       placeholder="Contoh: SOP"
                       oninput="this.value = this.value.toUpperCase()">
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Digunakan sebagai awalan nomor dokumen, contoh: SOP-HR-001</p>

        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="password" name="password"
                           class="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('password') border-red-400 dark:border-red-500 @enderror">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="role"
                            class="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('role') border-red-400 dark:border-red-500 @enderror">
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('users.index') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">Batal</a>
            </div>
        </form>
    </div>
</div>

        ...
        <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $user->email) }}"
                           class="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('email') border-red-400 dark:border-red-500 @enderror">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="role" class="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select name="department_id" class="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
